...
export default class AboutTeam {
  ...
  constructor(container: HTMLElement) {
    ...
    this.createItemTeam('../../../assets/teamPhoto/bg2.jpg', 'Фон', 'img1', '../../../assets/teamPhoto/veronika.png', 'Artem', 'Артем', 'Учебник, игра "Аудиовызов"', 'https://github.com/abram31', 'https://www.linkedin.com/in/artem-abramovich-45a06a230/');
